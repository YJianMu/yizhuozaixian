...
#define APP_ID          @"wxcb16acafc732ad32"//改了               //APPID
#define APP_SECRET      @"a5e4a97cc710aa72de8ce0d0e44e6867" //改了 //appsecret
//商户号，填写商户对应参数
#define MCH_ID          @"1327821301"//改了
//商户API密钥，填写相应参数
#define PARTNER_ID      @"0vb546lZJiUinx4wrGKqey43vmC4dig1" //改了
//支付结果回调页面
