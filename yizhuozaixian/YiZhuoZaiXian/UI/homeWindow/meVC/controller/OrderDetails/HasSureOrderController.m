...
@interface HasSureOrderController ()<UITableViewDataSource,UITableViewDelegate,MerchantInformationHeaderViewDelegate,UIGestureRecognizerDelegate>
...
@implementation HasSureOrderController
...
- (void)phoneToMerchant{
    __weak HasSureOrderController *weakself = self;
